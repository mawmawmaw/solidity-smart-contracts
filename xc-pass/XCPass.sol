...
contract XCPass is ERC721Enumerable, Ownable {
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    require(_mintAmount <= maxMintAmount, "The maximum minting amount is 5.");
  ...
  function toggleWhitelistSale(bool _state) public onlyOwner {
    whitelistSale = _state;
  }
  function toggleWhitelistRegistration(bool _state) public onlyOwner {
    whitelistRegistrationActive = _state;
  }
